...
|---------|-------|-------------|
| [FIMS](https://github.com/noaa-fims/fims/) | ![fims-stars](https://img.shields.io/github/stars/noaa-fims/fims?style=social) | Fisheries Integrated Modelling System |
| [asar](https://github.com/nmfs-ost/asar) | ![asar-stars](https://img.shields.io/github/stars/nmfs-ost/asar?style=social) | Partially Automated Stock Assessment Reporting |
| [stockplotr](https://github.com/nmfs-ost/stockplotr) | ![stockplotr-stars](https://img.shields.io/github/stars/nmfs-ost/stockplotr?style=social) | Tables and figures for stock assessment documents |
| [ss3-source-code](https://github.com/nmfs-ost/ss3-source-code) | ![ss3-stars](https://img.shields.io/github/stars/nmfs-ost/ss3-source-code?style=social) | Stock Synthesis source code |
| [DisMAP](https://apps-st.fisheries.noaa.gov/dismap/index.html) | ![dismap-stars](https://img.shields.io/github/stars/nmfs-ost/DisMAP?style=social) | Distribution Mapping and Analysis Portal |
| [FIT](https://nmfs-ost.github.io/noaa-fit/) | ![fit-stars](https://img.shields.io/github/stars/nmfs-ost/noaa-fit-resources?style=social) | Fisheries Integrated Toolbox |
| [journals](https://github.com/nmfs-ost/journals) | ![journals-stars](https://img.shields.io/github/stars/nmfs-ost/journals?style=social) | Bibliography files for journals of interest to fisheries |
| [nmfspalette](https://github.com/nmfs-ost/nmfspalette) | ![nmfspalette-stars](https://img.shields.io/github/stars/nmfs-ost/nmfspalette?style=social) | R Color palette for NOAA Fisheries official colors |
